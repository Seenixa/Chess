...
bool isValidBishopMove(string table[8][8], int originalXposition, int originalYposition, int newXposition, int newYposition, char color){
    ...
    while(checkingXPosition < 7 && checkingYPosition < 7){
        ...
        if (checkingXPosition == newXposition && checkingYPosition == newYposition){
            return true;
        }
    }
...
bool isValidKingMove(string table[8][8], int originalXposition, int originalYposition, int newXposition, int newYposition, char color){
    ...
    if (originalXposition + 1 == newXposition && originalYposition == newYposition && originalXposition + 1 < 8 ){
        return true;
    }
    ...
    if (originalXposition == newXposition && originalYposition + 1 == newYposition && originalYposition + 1 < 8){
        return true;
    }

    if (originalXposition == newXposition && originalYposition - 1 == newYposition && originalYposition - 1 >= 0){
        return true;
    }
    ...
    if (originalXposition - 1 == newXposition && originalYposition == newYposition && originalXposition - 1 >= 0){
        return true;
    }
